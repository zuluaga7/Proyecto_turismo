    ...
    <div className='cuerpo'>
      ...
      <section>
        <aside className='texto'>
          <p >
          Antioquia es uno de esos lugares en los que no paras de sorprenderte.
          sea por su gente, sus paisajes, su movimiento o simplemente por la calidad de sus servicios, todo aquel que quiera hacer turismo en Colombia
          debería apartar unos días solo para recorrer este mágico departamento .

          Hoy, quiero que conozcamos un poquito de todo lo que tiene para ofrecer. Hablaremos sobre qué visitar en Antioquia y algunos de los planes turísticos en
          sus pueblos y la vibrante ciudad de Medellín.

          ¿Por qué visitar Medellín?

          Se le conoce como la ciudad de la eterna primavera, la segunda ciudad de Colombia y capital del Departamento de Antioquia. Se trata de un lugar
